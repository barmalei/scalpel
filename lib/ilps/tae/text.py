...
from ilps.common.xml.grabber import XmlPathFilter, XmlGrabber
...
class TestTextFile(Text):
    def _set_data(self, data, encoding):        
        with codecs.open(os.path.join(ILPS_LIB_HOME, "corpora", "test", data), 'r', encoding=encoding) as f: return f.read()
