...
from gravity.tae.corpora.conll import CoNLL2000
from gravity.tae.internal.jvm import JavaBasedTagger


class POS(gravity.tae.pos.pos.POS, JavaBasedTagger):
    def __init__(self, lang='nl', model=None):
        gravity.tae.pos.pos.POS.__init__(self, lang)
    ...
    def java_class(self):
        return "gravity.tae.pos.stanford.POS"
