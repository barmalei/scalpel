...
class NER(gravity.tae.ner.ne.NER, TNTExternalTool):
    def __init__(self, lang='nl'):
        if lang != 'nl': raise BaseException("Only dutch language is supported")
        gravity.tae.ner.ne.NER.__init__(self, lang)
        TNTExternalTool.__init__(self, lang, gravity.tae.ner.ne.NER.NamedEntityGlue())
